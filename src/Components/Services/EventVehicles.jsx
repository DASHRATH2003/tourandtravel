  ...
  return (
    <div className="pt-20">
      ...
      <div className="bg-yellow-500  mt-[-100px] py-16 relative">
        <h1 className="text-5xl font-bold text-white text-center">Vehicles for Events & Tours</h1>
          ...
          <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="md:w-1/2">
              <div className="bg-gray-100 rounded-lg p-8">
                <img 
                  src="https://5.imimg.com/data5/SELLER/Default/2024/5/420204787/ZH/YU/XU/222470133/innova-hycross-car-rent-bangalore-500x500.jpeg" 
                  alt="Luxury Vehicle" 
